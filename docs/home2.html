          ...
          <div class="container">
              ...
              <div class="albums-carousel">
                  ...
                  <div class="album">
                      ...
                      <div class="hover">
                          <ul>
                              <li><a href="assets/img/gallery/2.jpg" data-rel="prettyPhoto"><span class="fa fa-search"></span></a></li>
                              <li><a href="album-detail.html"><span class="fa fa-link"></span></a></li>
                          </ul>
                          <h3>Lorem Artist</h3>
                          <h2>Album</h2>
           ...
           <div class="events_showcase" style="display:none">
              <div class="container">
                  ...
                  <div class="row">
                          ...
                          <div class="text-center">
                              ...
                              <div class="btn-group">
                                <button type="button" class="btn dropdown-toggle" data-toggle="dropdown">
                                  Month <span class=" fa fa-caret-down"></span>
                                </button>
                              ...
                              <div class="btn-group">
                                <button type="button" class="btn dropdown-toggle" data-toggle="dropdown">
                                  Year <span class=" fa fa-caret-down"></span>
                                </button>
                                <ul class="dropdown-menu" role="menu">
                                  <li><a href="#">2013</a></li>
                                  <li><a href="#">2012</a></li>
                      ...
                      <div class="col-lg-5 col-md-5 col-sm-5 col-xs-12">
                          <h3>events on <span>Dec, 2013</span></h3>
                          <div class="event-feed">
          ...
          <div class="container">         
             <div class="row">
                  <div class="col-lg-6 col-md-6 col-sm-6">
                      ...
                      <div class="news-feed">
                          <img src="assets/img/news/2.jpg" alt="dummy">
                          <a href="#">Drake's Nothing Was The Same Cover Explained!</a>
                          <ul>
                              <li>4 hours ago</li>
                              <li><span class="fa fa-comment"></span>5 comments</li>
                          </ul>
                      ...
                      <div class="news-feed">
                          ...
                          <a href="#">Kanye Lets Guard Down In 'Joy'-Filled Talk About Kim And North</a>
                          <ul>
                              <li>4 hours ago</li>
                              <li><span class="fa fa-comment"></span>5 comments</li>
                          </ul>
                      ...
                      <div class="news-feed">
                          ...
                          <a href="#">Drake's 'Smoove' Album Cover Has Fans Doing Blue Ivy Double-Take</a>
                          <ul>
                              <li>4 hours ago</li>
                              <li><span class="fa fa-comment"></span>5 comments</li>
                          </ul>
                  ...
                  <div class="col-lg-3 col-md-3 col-sm-3">
                      <div class="store-item">
                          <h1>new in store</h1>
                          <img src="assets/img/news/t-shirt.png" alt="">
                          <h3>music band T-shirt</h3>
                          <h5>$29.50</h5>
                          <a class="btn"><b class=" fa fa-random"></b>buy now</a>
                      </div><!--store item ends-->
                  </div><!--new in store-->
