        ...
        <div class="container">
                ...
                <div class="album-detail">
                    <div class="album-purchase">
                        <div class="col-lg-3 col-md-3 col-sm-3">
                            <img src="assets/img/albums/detail.jpg" alt=""/>
                            <a href="#">Buy Mp3 Album<span>$10.49</span></a>
                            <a href="#">Buy CD Album<span>$12.66</span></a>
                        </div>
                        </div>
                                ...
                                <div class="track">
                                    ...
                                    <ul>
                                        <li class="track-head clearfix">
                                            <div class="track_title">song title</div>
                                            <div class="track_listen">Listen</div>
                                            <div class="track_time">time</div>
                                            <div class="track_popularity">popularity</div>
                                            <div class="track_buy">Buy</div>
                                        </li>
                                        
                                        <li class="clearfix">
                                            <div class="track_title">Lorem Ipsum</div>
                                        ...
                                        <li class="clearfix">
                                            <div class="track_title">dolor sit amet</div>
                                            <div class="track_listen">
                                                <span  data-title="Maroon 5 - Moves Like Jagger" data-artist="ft. Christina" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3" title="add to playlist"> <i class="fa fa-play"></i></span>
                                            </div>
                                            <div class="track_time">4:17</div>
                                        ...
                                        <li class="clearfix">
                                            <div class="track_title">consectetur adipiscing elit</div>
                                            <div class="track_listen">
                                                <span  data-title="Maroon 5 - Moves Like Jagger" data-artist="ft. Christina" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3" title="add to playlist"> <i class="fa fa-play"></i></span>
                                            </div>
                                            <div class="track_time">4:17</div>
                                        ...
                                        <li class="clearfix">
                                            <div class="track_title">Maecenas vel est dolor</div>
                                            <div class="track_listen">
                                                <span  data-title="Maroon 5 - Moves Like Jagger" data-artist="ft. Christina" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3" title="add to playlist"> <i class="fa fa-play"></i></span>
                                            </div>
                                            <div class="track_time">4:17</div>
                                        ...
                                        <li class="clearfix">
                                            <div class="track_title"> Cras vel nisi</div>
                                            <div class="track_listen">
                                                <span  data-title="Maroon 5 - Moves Like Jagger" data-artist="ft. Christina" data-mp3="http://www.jplayer.org/audio/mp3/TSP-01-Cro_magnon_man.mp3" title="add to playlist"> <i class="fa fa-play"></i></span>
                                            </div>
                                            <div class="track_time">4:17</div>
            ...
            <h1>you might also like</h1>
                <div class="related-album">
                    <a href="#"><img src="assets/img/albums/related1.jpg" alt="/"></a>
                    <h3>Golden</h3>
                    <h4>Lady Antebellum</h4>
                </div>
                
                <div class="related-album">
                    <a href="#"><img src="assets/img/albums/related2.jpg" alt="/"></a>
                    <h3>wrapped in red</h3>
                    <h4>kelly clarkson</h4>
                </div>
                
                <div class="related-album">
                    <a href="#"><img src="assets/img/albums/related3.jpg" alt="/"></a>
                    <h3>pitch perfect soundtrack</h3>
                    <h4>Lady Antebellum</h4>
                </div>
                
                <div class="related-album">
                    <a href="#"><img src="assets/img/albums/related4.jpg" alt="/"></a>
                    <h3>am</h3>
                    <h4>artik money</h4>
                </div>
            </div>       
