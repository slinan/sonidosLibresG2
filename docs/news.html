             ...
             <div class="container">
                  <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6">
                          <h1>latest news</h1>
                          <h5>News related to on going music events</h5>
                      </div>
              ...
              <div class="row">
                  ...
                  <div class="col-lg-9 col-md-9 col-sm-9">
                      <div class="news-wrapper">
                          <div class="news-feed style-news">
                              <img src="assets/img/news/a.png" alt="dummy">
                          ...
                          <div class="news-feed">
                              <img src="assets/img/news/b.png" alt="dummy">
                              <h2><a href="#">Drake's Nothing Was The Same Cover Explained!</a></h2>
                              <ul>
                                  <li>4 hours ago</li>
                                  <li><span class="fa fa-comment"></span>5 comments</li>
                              </ul>
                          ...
                          <div class="news-feed">
                              <img src="assets/img/news/c.png" alt="dummy">
                              <h2><a href="#">Kanye Lets Guard Down In 'Joy'-Filled Talk About Kim And North</a></h2>
                              <ul>
                                  <li>4 hours ago</li>
                                  <li><span class="fa fa-comment"></span>5 comments</li>
                              </ul>
                          ...
                          <div class="news-feed">
                              <img src="assets/img/news/d.png" alt="dummy">
                              <h2><a href="#">Drake's 'Smoove' Album Cover Has Fans Doing Blue Ivy Double-Take</a></h2>
                              <ul>
                                  <li>4 hours ago</li>
                                  <li><span class="fa fa-comment"></span>5 comments</li>
                              </ul>
                          ...
                          <div class="news-feed">
                              <img src="assets/img/news/e.png" alt="dummy">
                              <h2><a href="#">Drake's 'Smoove' Album Cover Has Fans Doing Blue Ivy Double-Take</a></h2>
                              <ul>
                                  <li>4 hours ago</li>
                                  <li><span class="fa fa-comment"></span>5 comments</li>
                          ...
                          <div class="news-feed">
                              <img src="assets/img/news/f.png" alt="dummy">
                              <h2><a href="#">Drake's 'Smoove' Album Cover Has Fans Doing Blue Ivy Double-Take</a></h2>
                              <ul>
                                  <li>4 hours ago</li>
                                  <li><span class="fa fa-comment"></span>5 comments</li>
                          ...
                          <div class="news-feed">
                              <img src="assets/img/news/g.png" alt="dummy">
                              <h2><a href="#">Drake's 'Smoove' Album Cover Has Fans Doing Blue Ivy Double-Take</a></h2>
                              <ul>
                                  <li>4 hours ago</li>
                                  <li><span class="fa fa-comment"></span>5 comments</li>
                          ...
                          <div class="news-feed">
                              <img src="assets/img/news/h.png" alt="dummy">
                              <h2><a href="#">Drake's 'Smoove' Album Cover Has Fans Doing Blue Ivy Double-Take</a></h2>
                              <ul>
                                  <li>4 hours ago</li>
                                  <li><span class="fa fa-comment"></span>5 comments</li>
